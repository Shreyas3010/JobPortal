...
$con=mysqli_connect("127.0.0.1","root","")or
    ...
    if($otp==$otpValue){
$qry = "INSERT INTO `com_su`(username,email,password,address,contact,imagetmp,imagename) VALUES('$name','$email','$password','$address','$contact','$imagetmp','$imagename')";
		...
		{
			echo '<script type="text/javascript">alert("Account already exists!!!"); location="com_su.php";</script>';
		}	
	}else{
		echo '<script>alert("Wrong OTP!!."); location="com_su.php";</script>';
	}
            ...
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Registration Form</h2>
						<form name="com_su" action="com_su.php" method="post"  enctype="multipart/form-data">
	...
	$mail = new PHPMailer(true);       
		try {
			...
			echo "<script> location='com_su.php';</script>";
					...
					<div  align="center" ><br>
      <p  >If You Are Already Registered Then Please <a href="com_login.php" style="font-weight:bold;"> Login</a></p>
    </div>
                </div>
            </div>
        </div>
