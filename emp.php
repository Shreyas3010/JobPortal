          ...
          <div class="col-10 col-xl-10 d-none d-xl-block">
            <nav class="site-navigation text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
				...
				<li><a href="search.php" target="target">Jobs</a></li>				
				<li><a href="aboutus.php" target="target">About</a></li>
				<li><a href="logout.php">Logout</a></li>
                <li><a href="emp_home.php" target="target"><span class="rounded bg-primary py-2 px-3 text-white"><?php echo $n['name'];  ?></span></a></li>
...
<div class="b">
<iframe src="emp_background.php" style="border:none;" width="100%" height="900px"  name="target"></iframe>
